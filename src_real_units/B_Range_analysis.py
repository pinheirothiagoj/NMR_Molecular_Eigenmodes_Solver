...
dri = 0.10e-10                          # units = m
ri = np.arange(3.50e-10,4.00e-10,dri)   # units = m
rf = 4.00e-10                           # units = m
...
plt.title('1/T₁₂(0) [1/s] vs ri/rf')
plt.ylabel('1/T₁₂(0) [1/s]')
plt.xlabel('ri/rf')
